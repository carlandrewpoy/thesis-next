...
export async function exportFunc(currentDateTime) {
  const fileName = `PROJECTS_(${currentDateTime})`
  ...
  const handleExport = () => {
    const title = [
      {
        A: `Projects: Exported(${currentDateTime})`,
      },
      {},
    ]
      ...
      CCIS: [
        {
          A: "No.",
          B: "Type",
          C: "Project/ Program/ Research",
          D: "Status",
          E: "Date Started",
          F: "Date Completed",
          G: "Date Extension",
          H: "Funding Agency",
          I: "Cooperating Agency",
          J: "Project Leader",
          K: "Research Workers",
          L: "Project Cost",
          M: "Beneficiaries",
    ...
    data.forEach((row) => {
      tables.CCIS.push({
        ...
        I: row.coopAgency,
        J: row.projectLeader,
        K: row.researchWorkers,
        L: row.approvedProjectCost,
        M: row.beneficiaries,
        N: row.mandatedProgram,
