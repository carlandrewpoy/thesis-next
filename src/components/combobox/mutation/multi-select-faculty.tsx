...
export const MultiSelectFacultyCombobox = ({
    selected,
    setSelected,
}: {
    selected: string[]
    ...
    return (
        <div className="relative col-span-12 text-sm">
            ...
            {/* Menu's */}
            {menuOpen ? (
                <div className="bg-card border z-10 absolute w-full max-h-52 mt-2 p-1 flex overflow-y-auto scrollbar-thin scrollbar-track-slate-50 scrollbar-thumb-slate-200">
                    <ul className="w-full">
                        {filteredTags?.length ? (
